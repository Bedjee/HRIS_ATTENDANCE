      ...
      <div className="py-6">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-6 flex items-center">
            <History className="h-8 w-8 text-navy-600" />
            <h1 className="ml-3 text-2xl font-bold text-navy-800">My Attendance</h1>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="rounded-xl bg-white p-4 shadow-sm">
              ...
              <p className="mt-1 text-2xl font-bold text-navy-800">{safeSummary.total_events || 0}</p>
            </div>
            <div className="rounded-xl bg-white p-4 shadow-sm">
              <div className="flex items-center">
              ...
              <p className="mt-1 text-2xl font-bold text-navy-800">{safeSummary.total_attendances || 0}</p>
            </div>
            <div className="rounded-xl bg-white p-4 shadow-sm">
              <div className="flex items-center">
              ...
              {safeSummary.most_recent ? (
                <div className="mt-1">
                  <p className="text-sm font-medium text-navy-700">{safeSummary.most_recent.event_title}</p>
              ...
              {data.length === 0 ? (
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    {data.map((record) => (
                      <tr key={record.id}>
                        <td className="px-4 py-4 text-sm font-medium text-navy-700">{record.event_title}</td>
