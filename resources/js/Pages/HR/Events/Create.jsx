...
export default function Create({ auth, clusters, departments, employees }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('hr.events.store'), {
            onSuccess: () => {
                toast.success('Event created successfully!');
                router.visit(route('hr.events.index')); // ✅ force redirect
            },
            onError: (errors) => {
            ...
            <div className="py-8 sm:py-12">
                <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-6 flex items-center">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-navy-800 sm:text-3xl">Create Event</h1>
